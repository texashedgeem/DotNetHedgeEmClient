...
public partial class frm_hedgeem_table : System.Web.UI.Page
{
    ...
    {
        string my_game_id = _global_game_state_object.p_game_id;
    ...
    public List<HedgeEmBet> f_get_previous_bets_for_stage_and_hand_player_list(enum_betting_stage a_enum_betting_stage, int a_hand_index, int a_player_id)
    {
        ...
        catch (Exception ex)
        {
           ...
           // ClientScript.RegisterClientScriptBlock(this.GetType(), "Alert", my_error_popup, true);
            ...
            my_log_event.p_player_id = Convert.ToInt32(Session["p_session_player_id"]);
            my_log_event.p_game_id = p_game_id;
            my_log_event.p_table_id = p_session_personal_table_id;
            log.Error(my_log_event.ToString());
            HedgeemerrorPopup my_popup_message = new HedgeemerrorPopup();
            my_popup_message.p_detailed_message_str = "";
    ...
    {
        HedgeEmLogEvent my_log = new HedgeEmLogEvent();
        my_log.p_message = String.Format("Method called. Player [{0}], Table [{1}], Game [{2}]", Convert.ToInt32(Session["p_session_player_id"]), p_session_personal_table_id, p_game_id);
    ...
    #region f_place_bet_locally
    //This function is used to Maintain Hand Panel Values when Bet is Placed on a Hand.
    public void f_place_bet_locally()
    {
        HedgeEmLogEvent my_log = new HedgeEmLogEvent();
        my_log.p_message = String.Format("Method called. Player [{0}], Table [{1}], Game [{2}]", Convert.ToInt32(Session["p_session_player_id"]), p_session_personal_table_id, p_game_id);
        my_log.p_method_name = "frm_hedgeem_table.f_place_bet_locally()";
        my_log.p_player_id = Convert.ToInt32(Session["p_session_player_id"]);
        my_log.p_game_id = p_game_id;
        my_log.p_table_id = p_session_personal_table_id;
        ...
        enum_betting_stage my_betting_stage = (enum_betting_stage)Session["sess_betting_stage_enum"];
        double current_bet_value = -777;
        double new_bet_value = -777;
        ...
        try
        {
            ...
            if (handindexbet == 0) { 
                ...
                //HedgeEmBet my_local_hedgeem_bet = new HedgeEmBet(p_session_player_id, f_get_current_betting_stage(), p_session_current_seat_id, handindexbet, 1);
                //_global_game_state_object.f_record_bet(my_local_hedgeem_bet);
            }
            ...
            // Record all bets from all hand includeing previous bets in to state object so HandPanels can be displayed correctly
            my_bet_value = Convert.ToInt32(txt_hidden_control_hand0_bet_value.Value);
            if (my_bet_value > 0)
            {
                HedgeEmBet my_local_hedgeem_bet = new HedgeEmBet(p_session_player_id, f_get_current_betting_stage(), p_session_current_seat_id, 0, my_bet_value);
                _global_game_state_object.f_record_bet(my_local_hedgeem_bet);
            }
            ...
            if (my_bet_value > 0)
            {
                HedgeEmBet my_local_hedgeem_bet = new HedgeEmBet(p_session_player_id, f_get_current_betting_stage(), p_session_current_seat_id, 1, my_bet_value);
                _global_game_state_object.f_record_bet(my_local_hedgeem_bet);
            }
            ...
            if (my_bet_value > 0)
            {
                HedgeEmBet my_local_hedgeem_bet = new HedgeEmBet(p_session_player_id, f_get_current_betting_stage(), p_session_current_seat_id, 2, my_bet_value);
                _global_game_state_object.f_record_bet(my_local_hedgeem_bet);
            }
            my_bet_value = Convert.ToInt32(txt_hidden_control_hand3_bet_value.Value);
            if (my_bet_value > 0)
            {
                HedgeEmBet my_local_hedgeem_bet = new HedgeEmBet(p_session_player_id, f_get_current_betting_stage(), p_session_current_seat_id, 3, my_bet_value);
                _global_game_state_object.f_record_bet(my_local_hedgeem_bet);
            }
        }
        catch (Exception ex)
        {
            ...
            //ClientScript.RegisterClientScriptBlock(this.GetType(), "Alert", my_error_popup, true);
            my_log = new HedgeEmLogEvent();
            my_log.p_message = "Exception caught in f_place_bet_locally function " + ex.Message;
            my_log.p_method_name = "f_place_bet_locally";
            my_log.p_player_id = Convert.ToInt32(Session["p_session_player_id"]);
            my_log.p_game_id = p_game_id;
            my_log.p_table_id = p_session_personal_table_id;
            log.Error(my_log.ToString());
            ...
            my_popup_message.p_is_visible = true;
            Place_Holder_Popup_Message.Controls.Add(my_popup_message);
            // xxx Warning this exception is not shown
        }
    }
    #endregion f_place_bet_locally
    ...
    protected void f_update_hedgeem_control_betting_panels_with_info_from_server()
    {
        ...
        try
        {
            ...
            if (!(my_theme == enum_theme.CASINO || my_theme == enum_theme.MOBILE || my_theme == enum_theme.WSOP || my_theme == enum_theme.RETRO || my_theme == enum_theme.LEO_VEGAS))
            {
    ...
    private void f_update_hedgeem_control_hand_panels_with_info_from_server_previous_bets()
    {
                ...
                for (int hand_index = 0; hand_index < number_of_hands; hand_index++)
                {
                    for (int seat_index = 0; seat_index < my_number_of_seats; seat_index++)
                    {
                        ...
                        catch (Exception e)
                        {
                            ...
                            my_popup_message.p_is_visible = true;
                            Place_Holder_Popup_Message.Controls.Add(my_popup_message);
                            my_log_event.p_message = "Exception caught in f_update_hedgeem_control_hand_panels_with_info_from_server_previous_bets function " + e.Message;
                            my_log_event.p_method_name = "f_update_hedgeem_control_hand_panels_with_info_from_server_previous_bets";
                            my_log_event.p_player_id = Convert.ToInt32(Session["p_session_player_id"]);
                            my_log_event.p_game_id = p_game_id;
                            my_log_event.p_table_id = p_session_personal_table_id;
                            log.Error(my_log_event.ToString());
        ...
        catch (Exception ex)
        {
            ...
            my_popup_message.p_is_visible = true;
            Place_Holder_Popup_Message.Controls.Add(my_popup_message);
            my_log_event.p_message = "Exception caught in f_update_hedgeem_control_hand_panels_with_info_from_server_previous_bets function " + ex.Message;
            my_log_event.p_method_name = "f_update_hedgeem_control_hand_panels_with_info_from_server_previous_bets";
            my_log_event.p_player_id = Convert.ToInt32(Session["p_session_player_id"]);
            my_log_event.p_game_id = p_game_id;
            my_log_event.p_table_id = p_session_personal_table_id;
    ...
    private void f_clear_players_bets_lablels()
    {
        ...
        catch (Exception ex)
        {
            ...
            my_popup_message.p_is_visible = true;
            Place_Holder_Popup_Message.Controls.Add(my_popup_message);
            my_log_event.p_message = "Exception caught in f_clear_players_bets_lablels function " + ex.Message;
            my_log_event.p_method_name = "f_clear_players_bets_lablels";
            my_log_event.p_player_id = Convert.ToInt32(Session["p_session_player_id"]);
            my_log_event.p_game_id = p_game_id;
            my_log_event.p_table_id = p_session_personal_table_id;
            log.Error(my_log_event.ToString());
...
/// <summary>
/// Implemented but not test- 8th Aug 2016
/// </summary>
/// <param name="a_betting_stage"></param>
/// <param name="a_hand_index"></param>
/// <param name="a_amount"></param>
/// <returns></returns>
    #region f_place_bet
    HedgeEmGameState f_place_multiple_bets_then_deal()
    {
        HedgeEmGameState my_hedgeem_game_state;
        // Create a 'log event' object to audit execution
        HedgeEmLogEvent my_log_event = new HedgeEmLogEvent();
        my_log_event.p_method_name = System.Reflection.MethodBase.GetCurrentMethod().ToString();
        my_log_event.p_message = "Method Entered.";
        ...
        enum_betting_stage my_current_enum_betting_stage = f_get_current_betting_stage();
        List<HedgeEmBet> my_bet_list = new List<HedgeEmBet>();
        if (Convert.ToInt16(txt_hidden_control_hand0_bet_value.Value) > 0)
        {
            my_hedgeem_bet0 = new HedgeEmBet(1, my_current_enum_betting_stage, 0, 0, Convert.ToInt16(txt_hidden_control_hand0_bet_value.Value));
        ...
        if (Convert.ToInt16(txt_hidden_control_hand1_bet_value.Value) > 0)
        {
            my_hedgeem_bet1 = new HedgeEmBet(1, my_current_enum_betting_stage, 0, 1, Convert.ToInt16(txt_hidden_control_hand1_bet_value.Value));
        ...
        if (Convert.ToInt16(txt_hidden_control_hand2_bet_value.Value) > 0)
        {
            my_hedgeem_bet2 = new HedgeEmBet(1, my_current_enum_betting_stage, 0, 2, Convert.ToInt16(txt_hidden_control_hand2_bet_value.Value));
        ...
        if (Convert.ToInt16(txt_hidden_control_hand3_bet_value.Value) > 0)
        {
            my_hedgeem_bet3 = new HedgeEmBet(1, my_current_enum_betting_stage, 0, 3, Convert.ToInt16(txt_hidden_control_hand3_bet_value.Value));
        ...
        try
        {
            ...
            //my_log_event.p_message = String.Format("f_place_bet called. Args Stage[{0}], Hand [{1}], Amount[{2}]", a_betting_stage.ToString(), a_hand_index, a_amount);
            //log.Debug(my_log_event.p_message);
            //string place_bet_endpoint = "code not written yet"
            // Call the Hedge'Em Webservices (via helper function) to place the bet.
            /*string place_bet_endpoint = String.Format("ws_place_bets_then_deal",
                                                        p_session_personal_table_id.ToString(),
                                                        a_hand_index.ToString(),
                                                        a_amount.ToString(),
                                                        a_betting_stage.ToString(),
            ...
            DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(List<HedgeEmBet>));
            MemoryStream mem = new MemoryStream();

            // Serialse the HedgeEm Bets ready to pass to server
            ser.WriteObject(mem, my_bet_list);
            ...
            // xxx if data is empty - i.e. if no bets have been place, this errors here
            if (data == "[]")
            {
                my_hedgeem_game_state = (HedgeEmGameState)f_get_object_from_json_call_to_server("get_next_game_state_object/" + p_session_personal_table_id + "," + Convert.ToInt32(Session["p_session_player_id"]), typeof(HedgeEmGameState));
            }
            else
            {
                webClient.UploadString(my_service_url + "ws_place_bets_then_deal", data);
                my_hedgeem_game_state = (HedgeEmGameState)f_get_object_from_json_call_to_server("get_game_state_object/" + p_session_personal_table_id, typeof(HedgeEmGameState));
            
            }
            // xxx two calls to server here when there should be one (i.e. the call above shoud return game state data
        ...
        catch (Exception e)
        {
            ...
            log.Error(my_log_event.ToString());
            my_hedgeem_game_state = new HedgeEmGameState();
            my_hedgeem_game_state.p_error_message = my_log_event.p_message;
            return my_hedgeem_game_state;
        }
    }
    #endregion f_place_bet
    ...
    protected void btn_Get_Clicked_Hand_Value_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            bool place_bets_locally = Convert.ToBoolean(WebConfigurationManager.AppSettings["place_bets_locally"]);
            ;
            if (place_bets_locally)
            {
                ...
                //txt_hidden_control_hand0_bet_value.Value = "7";
    ...
    private void f_update_hedgeem_control_jackpot_with_info_from_server()
    {
        try
        {
            ...
            my_control_jackpot.p_jackpot_balance = Math.Round(_global_game_state_object.p_jackpot_value,2);
    ...
    protected void btn_Get_Clicked_Player_Id_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            catch (Exception ex)
            {
                ...
                my_log_event.p_message = "Exception caught in btn_Get_Clicked_Player_Id_Click function " + ex.Message;
                my_log_event.p_method_name = "btn_Get_Clicked_Player_Id_Click";
                my_log_event.p_player_id = Convert.ToInt32(Session["p_session_player_id"]);
                my_log_event.p_game_id = p_game_id;
                my_log_event.p_table_id = p_session_personal_table_id;
                log.Error(my_log_event.ToString());
    ...
    protected void btn_play_for_real_deposit_pledge_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
           ...
           // ClientScript.RegisterClientScriptBlock(this.GetType(), "Alert", my_error_popup, true);
            ...
            my_popup_message.p_is_visible = true;
            Place_Holder_Popup_Message.Controls.Add(my_popup_message);
            my_log_event.p_message = "Exception caught in btn_play_for_real_deposit_pledge_Click function " + ex.Message;
            my_log_event.p_method_name = "btn_play_for_real_deposit_pledge_Click";
            my_log_event.p_player_id = Convert.ToInt32(Session["p_session_player_id"]);
            my_log_event.p_game_id = p_game_id;
            my_log_event.p_table_id = p_session_personal_table_id;
            log.Error(my_log_event.ToString());
        ...
        try
        {
            ...
            else
            {
                ...
                if (place_bets_locally)
                {
                    ...
                    // Reset local bets after each round
                    txt_hidden_control_hand0_bet_value.Value = "0";
                    txt_hidden_control_hand1_bet_value.Value = "0";
                    txt_hidden_control_hand2_bet_value.Value = "0";
                    txt_hidden_control_hand3_bet_value.Value = "0";
    ...
    public string get_clicked_name(string name)
    {
        // Create a 'log event' object to audit execution
        HedgeEmLogEvent my_log_event = new HedgeEmLogEvent();
        my_log_event.p_method_name = System.Reflection.MethodBase.GetCurrentMethod().ToString();
        ...
        {
            my_log_event.p_message = "Exception caught in get_clicked_name function " + ex.Message;
            log.Error(my_log_event.ToString());
        }
        return name;
    }
